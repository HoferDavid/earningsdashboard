...
@Component({
  selector: 'app-revenue-widget-favorites',
  standalone: true,
  imports: [],
  templateUrl: './revenue-widget-favorites.component.html',
  styleUrl: './revenue-widget-favorites.component.scss'
})
export class RevenueWidgetFavoritesComponent {
